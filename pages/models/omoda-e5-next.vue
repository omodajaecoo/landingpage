    ...
    <template #slidesSection>
      <SwiperSlide class="section first-page">
        <img loading="lazy" :src="ispc
            ? dir + 'images/models/E5NEXT/section1bg.webp'
            : dir + 'images/models/E5NEXT/section1bg_mob.webp'
          " class="banner" />
        <img loading="lazy" src="/images/models/E5NEXT/E5NEXT_Logo_Blanco.png" class="logoimg" />
      ...
      <SwiperSlide class="section fullpage-sub">
        <img loading="lazy" :src="ispc
            ? dir + 'images/models/E5NEXT/section2bg.webp'
            : dir + 'images/models/E5NEXT/section2bg_mob.webp'
          " class="banner" />
        <div class="title bottom-[20%] sm:bottom-[40px]">
          <div class="flex flex-col justify-center items-center space-y-[20px] sm:space-y-[50px]">
            <div class="section2-actions flex flex-wrap justify-center items-center px-[8px]">
              <BaseButton type="text" class="section2-action font-interSemiRegular text-[16px] sm:text-[20px] px-[10px] py-[10px] sm:px-[20px] sm:py-[20px] 
              border border-[#67B0C4] leading-none !bg-[#67B0C4]" @click="router.push(section2_btns[0].link)">
                {{ section2_btns[0].label }}
              </BaseButton>
              <a :href="section2_btns[1].link" target="_blank" rel="noopener" class="section2-action">
      ...
      <SwiperSlide class="section fullpage-sub">
        <img loading="lazy" :src="ispc
            ? dir + 'images/models/E5NEXT/section4bg.webp'
            : dir + 'images/models/E5NEXT/section4bg_mob.webp'
          " class="banner" />
        <div class="title bottom-[20%] sm:bottom-[40px]">
          <img loading="lazy" src="/images/models/title-left.webp" class="icon left-icon" v-if="ispc"/>
          <div class="flex flex-wrap justify-center items-center max-w-[1000px] px-[8px]">
      ...
      <SwiperSlide class="section collage_section" v-if="showDesktopSwiper">
        <div class="img-main">
          <div class="img-item">
            <Transition name="slide-fade">
              <img loading="lazy" src="/images/models/E5NEXT/section6-item1.webp" class="img" v-if="currentPage == 5" />
            </Transition>
            <div class="txt" style="text-align: left">
              <Transition name="slide-fade">
                <div class="title" v-if="currentPage == 5">
                  DETALLES FUTURISTAS RELÁMPAGO
                  <img loading="lazy" src="/images/models/page5Line-right.webp" class="icon icon-right" />
                </div>
              </Transition>
              <Transition name="slide-fade">
                <div class="memo" v-if="currentPage == 5">
                  <p>En su 360° el E5 NEXT entrega un diseño  puro con elegancia y modernidad que parte de la firma de OMODA incursiona en este SUV eléctrico.</p>
                </div>
              </Transition>
            </div>
          </div>
          <div class="img-item">
            <div class="txt" style="text-align: right">
              ...
              <Transition name="slide-fade">
                <div class="memo" v-if="currentPage == 5">
                  <p> Su silueta de fastback-SUV abandona la parrilla frontal para dejar una cara limpia y minimalista con ángulos marcados en cada centímetro.</p>
                </div>
              </Transition>
            </div>
            <Transition name="slide-fade">
              <img loading="lazy" src="/images/models/E5NEXT/section6-item2.webp" class="img" v-if="currentPage == 5" />
            </Transition>
          </div>
        </div>
      </SwiperSlide>
      <SwiperSlide class="section collage_section" v-if="showDesktopSwiper">
        <div class="img-main">
          <div class="img-item">
            <Transition name="slide-fade">
              <img loading="lazy" src="/images/models/E5NEXT/section7-item1.webp" class="img" v-if="currentPage == 6" />
            </Transition>
            <div class="txt" style="text-align: left">
              <Transition name="slide-fade">
          ...
          <div class="img-item">
            ...
            <Transition name="slide-fade">
              <img loading="lazy" src="/images/models/E5NEXT/section7-item2.webp" class="img" v-if="currentPage == 6" />
            </Transition>
          </div>
        </div>
      </SwiperSlide>
            ...
            <div class="txt" style="text-align: left">
              ...
              <Transition name="slide-fade">
                <div class="memo" v-if="currentPage >= 7">
                  <p>El OMODA E5 NEXT cuenta con estándares de seguridad a la par de tus necesidades: cámara 360°*, 7 airbags* y con certificación de 5 estrellas en la EURO NCAP & AUSTRALIA NCAP*.
                  </p>
                </div>
              </Transition>
            </div>
        ...
        <Swiper class="insideSwiper" style="width: 100%; height: 100vh; transform: none"
          ...
          <SwiperSlide class="mobile-collage_section" v-if="showMobileSwiper">
            <div class="img-main">
              <div class="img-item item1">
                <img loading="lazy" src="/images/models/E5NEXT/section6-item1.webp" class="img animate__animated animate__fadeIn" />
                <Transition name="slide-fade">
                  <div class="flex w-full justify-center items-center title-content">
                    <p class="title-text font-interRegular"  v-if="currentPage >= 5">Detalles futuristas relámpago</p>
                  </div>
                </Transition>
              </div>
              <div class="img-item item2">
                <img loading="lazy" src="/images/models/E5NEXT/section6-item2.webp"
                  class="img animate__animated animate__fadeIn" />
                <Transition name="slide-fade">
                  <div class="flex w-full justify-center items-center title-content">
                    <p class="title-text font-interRegular"  v-if="currentPage >= 5">Diseño estilo mecha</p>
                  </div>
                </Transition>
              </div>
              <div class="img-item item3">
                <img loading="lazy" src="/images/models/E5NEXT/section7-item1.webp"
                  class="img animate__animated animate__fadeIn" />
                <Transition name="slide-fade">
                  <div class="flex w-full justify-center items-center title-content">
              ...
              <div class="img-item item4">
                <img loading="lazy" src="/images/models/E5NEXT/section7-item2.webp" class="img animate__animated animate__fadeIn" />
                <Transition name="slide-fade">
                  <div class="flex w-full justify-center items-center title-content">
          ...
          <SwiperSlide style="height: auto; display: block">
            <div class="min-h-[100vh] flex flex-col">
              <ClientOnly fallback-tag="span" fallback="Loading comments...">
                <ConfigTable class="flex-1" data-url="excels/e5next.xlsx" specialVersion="Luxury" title="Tabla de parámetros de configuración del OMODA E5 NEXT" />
              </ClientOnly>
...
var section2_tittle = ["LA", "SIGUIENTE", "GENERACIÓN", "100%","ELÉCTRICO.",
  "EL", "OMODA", "E5", "NEXT", "BRINDA", "EL", "SIGUIENTE", "NIVEL", "DE", "UNA", "CONDUCCIÓN", "INSTANTÁNEA,", "SILENCIOSA", "Y", "TECNOLOGÍA.",
  "PERSONALIDAD", "PROPIA", "Y", "DESEMPEÑO", "QUE", "SE", "ADAPTA", "A", "TU", "RITMO."
];
var section2_btns: Array<{ label: string; link: string }> = [
  ...
  {
    label: "FICHA TÉCNICA",
    link: "/files/Ficha_Tecnica_OMODA-E5-NEXT.pdf"
  }
];

var section3_slides: Array<swiperItem> = [
  {
    label: ["MOTOR", "DE", "ALTO", "RENDIMIENTO,", "OTORGA", "AUTONOMÍAS", "SUPERIORES", "EN", "SU", "SEGMENTO", "Y", "GARANTÍA", "DE", "8", "AÑOS", "/", "150.000", "KILÓMETROS."],
    txtarr: {},
...
var section3_slides_mob: sideswiperItem[] = [
  {
    ...
    txt: "Motor de alto rendimiento, otorgando autonomías superiores en su segmento y garantía de 8 años / 150.000 kilómetros.",
  },
  {
...
var section4_tittle = ["ESTILO", "DE", "DISEÑO", "TIPO", "MECHA,", "UNA", "RUPTURA", "VISUAL", "A", "LO", "ESTABLECIDO", "EN", "EL", "MERCADO"];
...
var section5_slides: Array<swiperItem> = [
    {
    label: ["RENOVADO", "PANEL", "INTERIOR", "CON", "PANTALLAS", "DE", "HASTA", "15.6", "PULGADAS", "CON", "DEFINICIÓN", "2K"],
    txtarr: {},
    imgsrc: dir + "images/models/E5NEXT/section5-item1.webp",
    isvideo: false,
    vsrc: "",
    ismask: true,
  },
  {
    label: ["CARGA", "RÁPIDA", "WIRELESS", "DE", "CELULAR", "CON", "VENTILACIÓN*"],
    txtarr: {},
    imgsrc: dir + "images/models/E5NEXT/section5-item2.webp",
    isvideo: false,
    vsrc: "",
    ismask: true,
  }
...
var section5_slides_mob: sideswiperItem[] = [
  {
    // mobile version of section5-item1.webp
    src: dir + "images/models/E5NEXT/section5-item1.webp",
    txt: "Renovado panel interior, con pantallas de hasta 15.6 pulgadas con definición 2k.",
  },
  {
    // mobile version of section5-item2.webp
    src: dir + "images/models/E5NEXT/section5-item2.webp",
    txt: "Carga rápida wireless de celular con ventilación*.",
  },
];
