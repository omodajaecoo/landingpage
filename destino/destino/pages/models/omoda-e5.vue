        ...
        >
          ...
          <SwiperSlide style="height: auto; display: block">
            <div class="min-h-[100vh] flex flex-col">
              <ClientOnly fallback-tag="span" fallback="Loading comments...">
                <xlsxTable class="flex-1" model-name="E5"></xlsxTable>
              </ClientOnly>
...
function handleMessage(event: any) {
  if (goon == true) {
    goon = false;
    var fullpageElement = document.querySelector(".fullPageContainer") as any;
    if (fullpageElement) {
      var fullpage = fullpageElement.swiper;
