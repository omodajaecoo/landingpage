    ...
    <template #slidesSection>
      <SwiperSlide class="section first-page">
        <img loading="lazy" :src="ispc
            ? dir + 'images/models/C5/section1bg.webp'
            : dir + 'images/models/C5/section1bg_mob.webp'
          " class="banner" />
      ...
      <SwiperSlide class="section fullpage-sub">
        <img loading="lazy" :src="ispc
            ? dir + 'images/models/C5/section2bg.webp'
            : dir + 'images/models/C5/section2bg_mob.webp'
          " class="banner" />
      ...
      <SwiperSlide class="section fullpage-sub">
        <img loading="lazy" :src="ispc
            ? dir + 'images/models/C5/section4bg.webp'
            : dir + 'images/models/C5/section4bg_mob.webp'
          " class="banner" />
        <div class="title bottom-[20%] sm:bottom-[40px]">
          <img loading="lazy" src="/images/models/title-left.webp" class="icon left-icon" v-if="ispc"/>
          <div class="flex flex-wrap justify-center items-center max-w-[1000px]">
      ...
      <SwiperSlide class="section collage_section" v-if="ispc">
        <div class="img-main">
          <div class="img-item">
            <Transition name="slide-fade">
              <img loading="lazy" src="/images/models/C5/section6-item1.webp" class="img" v-if="currentPage == 5" />
            </Transition>
          ...
          <div class="img-item">
            <div class="txt" v-if="ispc" style="text-align: right">
              ...
              <Transition name="slide-fade">
                <div class="memo" v-if="currentPage == 5">
                  <p>Su lenguaje ART IN MOTION combina las mejores estéticas automotrices en un SUV de la nueva era.</p>
                </div>
              </Transition>
            </div>
            <Transition name="slide-fade">
              <img loading="lazy" src="/images/models/C5/section6-item2.webp" class="img" v-if="currentPage == 5" />
            </Transition>
          </div>
        </div>
      </SwiperSlide>
      <SwiperSlide class="section collage_section" v-if="ispc">
        <div class="img-main">
          <div class="img-item">
            <Transition name="slide-fade">
              <img loading="lazy" src="/images/models/C5/section7-item1.webp" class="img" v-if="currentPage == 6" />
            </Transition>
            <div class="txt" style="text-align: left">
              <Transition name="slide-fade">
                <div class="title" v-if="currentPage == 6">
                  SONY AUDIO* EXPERIENCE
                  <img loading="lazy" src="/images/models/page5Line-right.webp" class="icon icon-right" />
                </div>
              </Transition>
              <Transition name="slide-fade">
          ...
          <div class="img-item">
            <div class="txt" v-if="ispc" style="text-align: right">
              ...
              <Transition name="slide-fade">
                <div class="memo" v-if="currentPage == 6">
                  <p>Su interior con elementos superiores diseñan una experiencia para ti, sunroof eléctrico*, luz ambiental interior y más.</p>
                </div>
              </Transition>
            </div>
            <Transition name="slide-fade">
              <img loading="lazy" src="/images/models/C5/section7-item2.webp" class="img" v-if="currentPage == 6" />
            </Transition>
          </div>
        </div>
      </SwiperSlide>
      <SwiperSlide class="section collage_section" v-if="ispc">
        <div class="img-main">
          <div class="img-item">
            <Transition name="slide-fade">
              <img loading="lazy" src="/images/models/C5/section8-item1.webp" class="img" v-if="currentPage >= 7" />
            </Transition>
            <div class="txt" style="text-align: left">
              <Transition name="slide-fade">
        ...
        <Swiper class="insideSwiper" style="width: 100%; height: 100vh; transform: none"
          ...
          <SwiperSlide class="mobile-collage_section" v-if="!ispc">
            <div class="img-main">
              <div class="img-item item1">
                <img loading="lazy" src="/images/models/C5/section6-item1.webp" class="img animate__animated animate__fadeIn" />
                <Transition name="slide-fade">
              ...
              <div class="img-item item2">
                <img loading="lazy" src="/images/models/C5/section6-item2.webp"
              ...
              <div class="img-item item3">
                <img loading="lazy" src="/images/models/C5/section7-item1.webp"
                  class="img animate__animated animate__fadeIn" />
                <Transition name="slide-fade">
                  <div class="flex w-full justify-center items-center title-content">
                    <p class="title-text font-interRegular"  v-if="currentPage >= 5">SONY AUDIO* EXPERIENCE</p>
                  </div>
                </Transition>
              </div>
              <div class="img-item item4">
                <img loading="lazy" src="/images/models/C5/section7-item2.webp" class="img animate__animated animate__fadeIn" />
                <Transition name="slide-fade">
                  <div class="flex w-full justify-center items-center title-content">
                    <p class="title-text font-interRegular"  v-if="currentPage >= 5">DETALLES QUE IMPORTAN</p>
                  </div>
                </Transition>
              </div>
              <div class="img-item item5">
                <img loading="lazy" src="/images/models/C5/section8-item1.webp" class="img animate__animated animate__fadeIn" />
                <Transition name="slide-fade">
                  <div class="flex w-full justify-center items-center title-content">
          ...
          <SwiperSlide style="height: auto; display: block">
            <div class="min-h-[100vh] flex flex-col">
              <ClientOnly fallback-tag="span" fallback="Loading comments...">
                <xlsxTable class="flex-1" model-name="C5"
                  title="Tabla de parámetros de configuración del OMODA C5"
...
var section2_tittle = ["CADA", "LÍNEA", "PROYECTA", "ENERGÍA,", "CADA", "MOVIMIENTO", "EQUILIBRIO.", "ASÍ", "SE", "SIENTE", "CONDUCIR", "EL", "OMODA", "C5", "SHS", "FULL", "HYBRID.", "SUS", "LÍNEAS", "FUTURISTAS", "PROYECTAN", "VIDA,", "Y", "ARTE", "EN", "CADA", "ÁNGULO."];
...
var section3_slides: Array<swiperItem> = [
  ...
  },
  {
    ...
    txtarr: {},
    imgsrc: dir + "images/models/C5/section3-item2.webp",
    isvideo: false,
    vsrc: "",
    ismask: true,
  }
...
var section4_tittle = ["ATMÓSFERA", "FUTURISTA,", "MATERIALES", "DE", "CALIDAD", "PREMIUM", "&", "VANGUARDIA", "EN", "INFOENTRETENIMIENTO"];
