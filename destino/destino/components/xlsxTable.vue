...
// https://www.baicglobal.com/file/upload/2023/06/05/BJ40%20PLUS%20Specifications_20220926182117A001_20230605175915A098.xlsx
if (process.client) {
  // http://hqq-chery-jaecoo.cloud-top.com.cn/excels/T1EJ.xlsx
  // http://chery-jaecoo.cloud-top.com.cn/excels/T1EJ.xlsx
  axios
    .get(dir + "excels/T1EJ.xlsx", {
...
@media (max-width: 1024px) {
  ...
  .params-table__title {
    ...
    margin: 0 0 calc(2.5 * 16 / 3.75 * 1vw) calc(2.5 * 16 / 3.75 * 1vw);
    .txt {
      position: absolute;
      top: 0.5rem;
      top: calc(0.5 * 16 / 3.75 * 1vw);
      left: 1rem;
      left: calc(1 * 16 / 3.75 * 1vw);
      color: #fff;
      text-align: left;
      width: 90%;
    }
